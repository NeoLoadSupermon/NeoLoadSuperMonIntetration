...
public class SendSuperMonContextAction implements Action {
    ...
    public List<ActionParameter> getDefaultActionParameters() {
        ...
        for (final SendSuperMonOptions option : SendSuperMonOptions.values()) {
    ...
    public Class<? extends ActionEngine> getEngineClass() {
        return SendSuperMonContextActionEngine.class;
    }

    @Override
    public Icon getIcon() {
        // TODO Add an icon
        return SuperMonUtils.getSupermonIcon();
    }
