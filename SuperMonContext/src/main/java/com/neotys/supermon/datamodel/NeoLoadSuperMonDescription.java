...
public class NeoLoadSuperMonDescription {
    ...
    */
    ...
    public NeoLoadSuperMonDescription(String project, String version, String revision, String testPlan, String testEnvironment, HashMap<String, String> customFields, List<String> tags, String fixVersions) {
